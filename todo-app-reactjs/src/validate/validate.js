...
const autoValidateConfirmPasswordWhenInputChange = (password, confirmPassword, setValid) => {
    const isConfirmPasswordMatchWithPassword = password === confirmPassword
    setValid(isConfirmPasswordMatchWithPassword)
}

export {autoValidateUsernameWhenInputChange, autoValidatePasswordWhenInputChange, autoValidateConfirmPasswordWhenInputChange}